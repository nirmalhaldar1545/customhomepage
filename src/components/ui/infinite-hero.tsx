...
import { MessageSquare, GraduationCap, Mail, HardDrive, Youtube } from "lucide-react";
...
export default function InfiniteHero() {
	...
	return (
		...
		>
			...
			<div className="absolute bottom-12 left-1/2 z-10 flex -translate-x-1/2 transform items-center justify-center gap-6">
				<a
				...
				>
					<div className="dots-border" />
					<HardDrive className="button-icon" />
					<span className="text-button">Drive</span>
				</a>
				...
				>
					<div className="dots-border" />
					<Youtube className="button-icon" />
					<span className="text-button">YouTube</span>
				</a>
				...
				>
					...
					<span className="text-button">ChatGPT</span>
				</a>
				...
				>
					...
					<span className="text-button">Coursera</span>
				</a>
			</div>
		</div>
	);
